...
$(".prev-project .project").on("click", function (e) {
  e.preventDefault();
  const targetModal = $(this).data("target");
  $.magnificPopup.close(); // Close the current modal first

  // Wait for the modal to close before opening the next
  setTimeout(function () {
    $.magnificPopup.open({
      items: {
        src: targetModal,
      ...
      callbacks: {
        beforeOpen: function () {
          // Remove mfp-hide class for smooth opening
          $(targetModal).removeClass("mfp-hide");
        },
        open: function () {
          // Add class to make it ready for smooth transition
          $(targetModal).addClass("mfp-ready");
        },
        close: function () {
          // Remove ready class when closing
          $(targetModal).removeClass("mfp-ready");
        },
      },
    });
...
$(".next-project .project").on("click", function (e) {
  e.preventDefault();
  const targetModal = $(this).data("target");
  $.magnificPopup.close(); // Close the current modal first
